...
class FluxAttnProcessor:
    ...
    def __call__(
        ...
        image_rotary_emb: Union[torch.Tensor, None] = None,
    ) -> torch.Tensor:
...
class FluxIPAdapterAttnProcessor(torch.nn.Module):
    ...
    def __call__(
        ...
        attention_mask: Union[torch.Tensor, None] = None,
        image_rotary_emb: Union[torch.Tensor, None] = None,
        ip_hidden_states: Union[List[torch.Tensor], None] = None,
        ip_adapter_masks: Union[torch.Tensor, None] = None,
    ) -> torch.Tensor:
...
class FluxAttention(torch.nn.Module, AttentionModuleMixin):
    ...
    def __init__(
        ...
        dropout: float = 0.0,
        bias: bool = False,
        added_kv_proj_dim: Union[int, None] = None,
        added_proj_bias: Union[bool, None] = True,
        out_bias: bool = True,
        eps: float = 1e-5,
        out_dim: int = None,
        context_pre_only: Union[bool, None] = None,
        pre_only: bool = False,
...
class FluxSingleTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        temb: torch.Tensor,
        image_rotary_emb: Union[Tuple[torch.Tensor, torch.Tensor], None] = None,
...
class FluxPosEmbed(nn.Module):
    def __init__(
            ...
            axes_dim: List[int],
            method: str = 'yarn',
            base_resolution_hw: Union[Tuple[int, int], None] = None,  # Training (H, W) resolution in pixels used to decouple YARN.
